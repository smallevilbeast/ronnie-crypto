...
mod tests {
    ...
    fn test_hkdf() {
        let key = hex
            ::decode("d8f0e69f37c161cd32e2246987478381ecff00c0b189840e3d1e9f9719812406")
            .unwrap();
        let info = hex
            ::decode("c06982567a20d01b1e07c4ee8ba834fee2935bdc6cb2412224ae87a9fd30f27e")
            .unwrap();
        let okm = hkdf_expand(&key, &info, 42).unwrap();
        let test_okm = hex
            ::decode(
                "4a190048d535dece319b88a1e93b8bd4d199247255785e5d1134c14aa9c1c794d0789f7f2fa8f520bef8"
            )
            .unwrap();
